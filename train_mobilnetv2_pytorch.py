...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes):
        ...
        self.model = torchvision.models.mobilenet_v2(pretrained=False, num_classes=num_classes)
...
def fit(parameters, config):
    ...
    for epoch in range(config['epochs']):
        ...
        validation_metrics.append({'validation_loss': validation_loss, 'validation_accuracy': validation_accuracy})
    ...
    metrics_df = pd.DataFrame({
        ...
        'validation_loss': [item['validation_loss'] for item in validation_metrics],
        'validation_accuracy': [item['validation_accuracy'] for item in validation_metrics],
...
# Example usage
config = {
    'epochs': 50  # Change this to the desired number of epochs
}
